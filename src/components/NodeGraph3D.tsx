      ...
      <Html distanceFactor={10}>
        <div className="pointer-events-none whitespace-nowrap">
          <div className={`text-xs font-mono font-bold px-2 py-1 rounded ${
            node.type === 'groq' ? 'bg-cyan-500/30 text-cyan-300 border border-cyan-500/50' :
...
export default function NodeGraph3D() {
  return (
    <div className="h-[400px] w-full rounded-xl overflow-hidden border border-cyan-500/30 bg-black/50 relative">
      {/* Overlay UI */}
      ...
      <div className="absolute bottom-4 right-4 z-10 text-xs text-gray-500 font-mono">
