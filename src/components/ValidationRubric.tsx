    ...
    <div className="p-4 space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs text-app-muted uppercase tracking-wider">Network Consensus</span>
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2 text-xs text-app-muted uppercase tracking-wider">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-app-primary text-sm font-medium">{agent.name}</span>
              </div>
              <div className="flex items-center gap-2">
